...
class ServicioAnalitica:
    ...
    def conectar(self):
        ...
        self.socket_rep_monitoreo.bind(f"tcp://{self.CONTROL_IP}:{self.CONTROL_PUERTO}")
        print(f"[ANALITICA] REP escuchando en tcp://{self.CONTROL_IP}:{self.CONTROL_PUERTO}")
